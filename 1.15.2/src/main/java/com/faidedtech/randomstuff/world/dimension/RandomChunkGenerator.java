...
public class RandomChunkGenerator extends NoiseChunkGenerator<RandomGenSettings> {
	...
	public RandomChunkGenerator(IWorld worldIn, BiomeProvider provider, RandomGenSettings settingsIn) {
