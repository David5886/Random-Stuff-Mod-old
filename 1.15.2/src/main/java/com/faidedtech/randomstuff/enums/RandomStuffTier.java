...
public enum RandomStuffTier implements IItemTier {
	...
	TOOL_SILVER(5, 350, 7.0F, 4, 15, () -> Ingredient.fromItems(RegistryHandler.SILVER_INGOT.get())),
	TOOL_OBSIDIAN(6, 1800, 10.0F, 4, 15, () -> Ingredient.fromItems(RegistryHandler.OBSIDIAN_INGOT.get())),
	TOOL_AMETHYST(4, 250, 5.0F, 4, 10, () -> Ingredient.fromItems(RegistryHandler.AMETHYST.get())),
